...
@section('title', 'Tambah Pengguna - SIKESAT')

@section('content')
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title"><i class="fas fa-user-plus"></i> Tambah Pengguna</h1>
    </div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('user.store') }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActive" {{ old('is_active', true) ? 'checked' : '' }} style="width: 2.5em; height: 1.25em;">
            ...
            <div class="text-end mt-3">
                <button type="submit" class="btn btn-primary px-4"><i class="fas fa-save"></i> Simpan Pengguna</button>
            </div>
        </form>
    </div>
</div>
