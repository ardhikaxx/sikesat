@extends('layouts.app')
@section('title', 'Detail SpmCapaian - SIKESAT')
@section('content')
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title"><i class="fas fa-eye"></i> Detail SpmCapaian</h1>
    </div>
...
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-body p-4">
        <table class="table table-striped mb-0">
            ...
            <tr><th width="25%">Spm Indikator Id</th><td>{{ $data->spm_indikator_id }}</td></tr>
            <tr><th width="25%">Periode Bulan</th><td>{{ $data->periode_bulan }}</td></tr>
            <tr><th width="25%">Periode Tahun</th><td>{{ $data->periode_tahun }}</td></tr>
            <tr><th width="25%">Nilai Capaian</th><td>{{ $data->nilai_capaian }}</td></tr>
