@extends('layouts.app')
@section('title', 'Detail UnitPelayanan - SIKESAT')
@section('content')
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title">Detail UnitPelayanan</h1>
        <a href="{{ route('unit-pelayanan.index') }}" class="text-decoration-none">&larr; Kembali</a>
    </div>
</div>
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-body p-4">
        <table class="table table-bordered">
            ...
            <tr><th width="25%">Kepala Unit</th><td>{{ $data->kepala_unit }}</td></tr>
