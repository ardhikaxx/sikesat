...
<body>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td class="font-bold">ARUS KAS DARI AKTIVITAS OPERASI</td>
                <td></td>
            </tr>
            <tr>
                <td style="padding-left: 20px;">Arus Kas Masuk</td>
                <td class="text-right">{{ number_format($data['arus_masuk'], 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td style="padding-left: 20px;">Arus Kas Keluar</td>
                <td class="text-right">({{ number_format($data['arus_keluar'], 2, ',', '.') }})</td>
            </tr>
            <tr class="font-bold bg-light">
                <td>Arus Kas Bersih dari Aktivitas Operasi</td>
                <td class="text-right">{{ number_format($data['arus_masuk'] - $data['arus_keluar'], 2, ',', '.') }}</td>
            </tr>
        </tbody>
    </table>
