...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title"><i class="fas fa-table"></i> Data PengajuanPengadaan</h1>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1">
                                <a href="{{ route('pengajuan-pengadaan.show', $item->id) }}" class="btn-action btn-action-view"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('pengajuan-pengadaan.edit', $item->id) }}" class="btn-action btn-action-edit"><i class="fas fa-pen"></i></a>
