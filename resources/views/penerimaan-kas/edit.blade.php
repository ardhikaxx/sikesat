...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title"><i class="fas fa-edit"></i> Edit PenerimaanKas</h1>
    </div>
...
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-body p-4">
        <form action="{{ route('penerimaan-kas.update', $data->id) }}" method="POST">
            ...
            <div class="mb-3">
                <label class="form-label fw-bold">Jenis Penerimaan</label>
            ...
            <div class="mb-3">
                <label class="form-label fw-bold">Pasien Id</label>
