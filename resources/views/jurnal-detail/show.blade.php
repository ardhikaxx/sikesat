@extends('layouts.app')
@section('title', 'Detail JurnalDetail - SIKESAT')
@section('content')
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title"><i class="fas fa-eye"></i> Detail JurnalDetail</h1>
    </div>
...
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-body p-4">
        <table class="table table-striped mb-0">
            ...
            <tr><th width="25%">Posisi</th><td>{{ $data->posisi }}</td></tr>
